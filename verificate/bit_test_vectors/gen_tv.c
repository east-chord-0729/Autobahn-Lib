...
/**
 * @brief generate operands test vectors
 * 
 * @param bitlen bit length of operands
 */
...
/**
 * @brief generate test vectors of operations.
 * 
 */
void generate_testvectors()
{
    ...
    FILE* f_result_pp = fopen(RESULT_SQR_FILEPATH_PP, "w");
    ...
    {   
        ...
        // opraiting
        mpz_mul(result_pp, operand_x_p, operand_x_p);
